/**
 * FuzzBuzz class is a class that contains an implementation of the fizzBuzz
 * algorithm For multiples of three print “Fizz” instead of the number For the
...
public class FizzBuzz {
	 ...
	 * 
	 * @param number
	 *            the value for which we need to compute fizzBuzz
